...
public class ThreadContext implements Closeable {
    ...
    private static final SafeThreadLocal.ThreadContextStruct DEFAULT_CONTEXT = new SafeThreadLocal.ThreadContextStruct();
    private final Map<String, String> defaultHeader;
    private final SafeThreadLocal.ContextThreadLocal threadLocal;
    ...
    public ThreadContext(Settings settings) {
        ...
        threadLocal = new SafeThreadLocal.ContextThreadLocal();
    }
    ...
    public StoredContext stashContext() {
        // 1. 记录上下文
        final SafeThreadLocal.ThreadContextStruct context = threadLocal.get();
