...
public class ReactiveExecutor_prod<T> {
    ...
    public ReactiveExecutor_prod(DirectedGraph<T> graph) {
        this.graph = graph;
    ...
    public static void main(String[] args) {
        ...
        ReactiveExecutor_prod<String> executor = new ReactiveExecutor_prod<>(graph);
        executor.start();
    }
}